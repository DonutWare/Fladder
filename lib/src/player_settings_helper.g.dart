...
// ignore_for_file: unnecessary_parenthesis, prefer_null_aware_operators, omit_local_variable_types
// ignore_for_file: unused_shown_name, unnecessary_import, no_leading_underscores_for_local_identifiers
...
class PlayerSettings {
  ...
  static PlayerSettings decode(Object result) {
    ...
    return PlayerSettings(
      ...
      ignoreHdr10Plus: result[1]! as bool,
      skipTypes: (result[2] as Map<Object?, Object?>?)!.cast<SegmentType, SegmentSkip>(),
      themeColor: result[3] as int?,
      skipForward: result[4]! as int,
      skipBackward: result[5]! as int,
      autoNextType: result[6]! as AutoNextType,
      acceptedOrientations: (result[7] as List<Object?>?)!.cast<PlayerOrientations>(),
      fillScreen: result[8]! as bool,
      videoFit: result[9]! as VideoPlayerFit,
      screensaver: result[10]! as Screensaver,
    );
  }
...
class PlayerSettingsPigeon {
  ...
  Future<void> sendPlayerSettings(PlayerSettings playerSettings) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.nl_jknaapen_fladder.settings.'
        'PlayerSettingsPigeon.sendPlayerSettings$pigeonVar_messageChannelSuffix';
