...
class _DefaultTitleBarState extends ConsumerState<DefaultTitleBar>
  ...
  Widget build(BuildContext context) {
    ...
    final disableTitleBar = ref.watch(
      clientSettingsProvider.select((value) => value.disableTitleBar),
    );
    final platform = AdaptiveLayout.of(context).platform;
    final bool removeTitleBar = switch (platform) {
      TargetPlatform.windows || TargetPlatform.linux => disableTitleBar,
      _ => false,
    };
                  ...
                  children: [
                    removeTitleBar
                        ...
                        : switch (platform) {
                            ...
                            TargetPlatform.iOS => SizedBox(
                              height: MediaQuery.paddingOf(context).top,
                            ),
                            TargetPlatform.windows ||
                            TargetPlatform.linux => Container(
                              child: Row(
                                children: [
                                  Expanded(
                                    child: Container(
