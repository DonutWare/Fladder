                    ...
                    children: [
                      ...
                      Flexible(
                        child: FloatingPlayerBarTitle(
                          title: item.title,
                          subtitle: item.artistNames.isNotEmpty ? item.artistNames.join(', ') : item.album ?? "",
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      IconButton.filledTonal(
                        ...
                        iconSize: 32,
                        icon:
                            playbackInfo.playing ? const Icon(IconsaxPlusBold.pause) : const Icon(IconsaxPlusBold.play),
                      ),
                      IconButton(
                        onPressed: onNext,
